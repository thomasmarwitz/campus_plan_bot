...
class ConversationProtocol(Protocol):
    ...
    id: str
    messages: Sequence[UserMessageProtocol | BotMessageProtocol]
...
class ResponseParser(Protocol):
    ...
    def parse(self, llm_response: LLMResponse) -> tuple[str, list[Action]]:
...
class OutputGenerator(Protocol):
    ...
    def generate(self, text: str, actions: list[Action]) -> BotMessageProtocol:
